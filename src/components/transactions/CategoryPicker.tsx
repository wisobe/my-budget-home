...
export function CategoryPicker({ value, categoryName, categoryColor, onSelect }: Props) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[200px] p-1 max-h-[var(--radix-popover-content-available-height,400px)] overflow-y-auto" align="start" side="bottom" collisionPadding={8}>
