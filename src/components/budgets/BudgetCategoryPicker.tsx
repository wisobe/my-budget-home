  ...
  return (
    <div className="relative">
      ...
      {open && (
        <>
          {/* Backdrop to close */}
          <div className="fixed inset-0 z-[60]" onClick={() => { setOpen(false); setExpandedParent(null); }} />
          
          <div className="absolute z-[61] mt-1 w-full rounded-md border bg-popover text-popover-foreground shadow-md">
